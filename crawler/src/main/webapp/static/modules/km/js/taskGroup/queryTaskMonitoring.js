...
define(function(require,exports,module){
	...
	exports.gridLoad = function(id){
		...
		var columns = [[
		               ...
		               /* {field:'id',checkbox:true},*/
		                ...
		                {field:'fullNumber',halign:'center',align:'center',width:120,title:'采集成功数'},
		               	{field:'failedNumber',halign:'center',align:'center',width:120,title:'采集失败数'},
	...
	exports.dataFilter=function(id){
		var fullState="";
		var incompleteDataState="";
		$("#fullData").on("click",function(){
		 var checkradio=$("input[name='fullData']:checked").val();
		 var checkradio2=$("input[name='incompleteData']:checked").val();
		 if(checkradio){
			 fullState="0";
			 }else{
			 fullState="1";	 
		 ...
		 if(checkradio2){	
				 incompleteDataState="0";
			 	}else{
			 	 incompleteDataState="1";	
			 	}
		 exports.gridLoad2(id,fullState,incompleteDataState);
		});
		
		$("#incompleteData").on("click",function(){
			 var checkradio=$("input[name='fullData']:checked").val();
			 var checkradio2=$("input[name='incompleteData']:checked").val();
			 if(checkradio){
				 fullState="0";
	...
	//数据查看列表
	exports.gridLoad2 = function(id,fullState,incompleteDataState){
		//请求连接
		var url = '../taskJobMonitor/taskDatumList.html';
		//请求参数
		var param = {'jobid':id,'fullState':fullState,'incompleteDataState':incompleteDataState};
		//列
		var columns = [[
		                //要显示的列
		               /* {field:'id',checkbox:true},*/
